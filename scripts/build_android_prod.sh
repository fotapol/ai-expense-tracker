...
EXPECTED_API_BASE_URL="${EXPECTED_API_BASE_URL:-https://api.example.com}"
EXPECTED_PRIVACY_URL="${EXPECTED_PRIVACY_URL:-https://example.com/privacy}"
EXPECTED_TERMS_URL="${EXPECTED_TERMS_URL:-https://example.com/terms}"
EXPECTED_DELETE_ACCOUNT_URL="${EXPECTED_DELETE_ACCOUNT_URL:-https://example.com/delete-account}"
EXPECTED_SUPPORT_EMAIL="${EXPECTED_SUPPORT_EMAIL:-support@example.com}"
