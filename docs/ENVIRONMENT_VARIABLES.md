...
| `APP_PRIVACY_URL` | External privacy-policy link shown in the app. | Optional | `https://example.com/privacy` | Set this to your real hosted privacy policy before publishing mobile builds. The bundled static site does not generate a privacy-policy page. | No |
| `APP_TERMS_URL` | External terms-of-service link shown in the app. | Optional | `https://example.com/terms` | Set this to your real hosted terms page before publishing mobile builds. The bundled static site does not generate a terms page. | No |
